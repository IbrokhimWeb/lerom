...
export const select = [
    ...
    ["Гостинные"],
    ["Прихожие"],
    ["Спальни", "Мелисса 2021", "Карина", "Камелия 2021"],
    ["Детские"],
    ["Кровати"],
    ["Матрасы"]
];
...
export const product = [
    {
        ...
        g: 352,
        svet: [
            { id, name: "color", img: color1 },
            { id, name: "color", img: color2 },
            { id, name: "color", img: color3 },
            { id, name: "color", img: color4 },
            { id, name: "color", img: color5 },
            { id, name: "color", img: color1 },
            { id, name: "color", img: color2 },
            { id, name: "color", img: color3 },
